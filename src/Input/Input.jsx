      ...
      <form className="form">
        ...
        <button onClick={(evt)=> important(evt)} className="form__button">
          <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="35" height="35" rx="11.25" fill={isImportant ? '#FF0000' : '#35383E'} fill-opacity={isImportant ? '0.9' : '0.25'} />
            <path d="M16 8.5H19V21.5H16V8.5Z" fill="white" />
            <path d="M16 23.5H19V26.5H16V23.5Z" fill="white" />
          </svg>
        </button>
        <button type="submit" onClick={evt=>submit(evt)} className={`form__button ${!(isFocused && value.length >=2) && 'form__button_disabled'}`} disabled={value.length < 2}>
          <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="35" height="35" rx="11.25" fill={(isFocused && value.length >=2) ? '#00CD2D' : '#35383E'} fill-opacity={(isFocused && value.length >=2) ? '0.8' : '0.25'} />
